...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .authorizeRequests()
                .antMatchers("/login", "api/user/user", "/register", "/register/action", "/loginFail", "/resource/**").permitAll()
            ...
            .and()
                ...
                .loginProcessingUrl("/login/action") // 로그인 액션 설정 (loginpage.html의 th:action="@{/login_action}"를 말함
